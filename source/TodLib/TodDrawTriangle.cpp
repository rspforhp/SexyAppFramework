...
#endif
void	funcname(Sexy::SWHelper::SWVertex* pVerts, void* pFrameBuffer, const unsigned int bytepitch, const Sexy::SWHelper::SWTextureInfo* textureInfo, Sexy::SWHelper::SWDiffuse& globalDiffuse)
{
	...
	const Sexy::SWHelper::signed64 bigOne = static_cast<Sexy::SWHelper::signed64>(1) << 48;
#define  swap(a,b,type) {type tmp = a; a = b; b = tmp;}
	...
	Sexy::SWHelper::SWVertex* v0 = pVerts + 0;
	Sexy::SWHelper::SWVertex* v1 = pVerts + 1;
	Sexy::SWHelper::SWVertex* v2 = pVerts + 2;
	...
	Sexy::SWHelper::signed64	topHeight = v1->y - v0->y;
	...
	Sexy::SWHelper::signed64	subPix = (y0 << 16) - v0->y;
	...
	Sexy::SWHelper::signed64	oneOverWidth;
